    ...
    for lngth in range(3, 11):
        ...
        for slvr in ["z3", "z3_2"]:
            ...
            if slvr == 'z3':
                ...
                tablesp_ortools.add_row([lngth, average_model_creation_time, average_transform_time, average_solve_time, average_execution_time, average_mem_usage])
                with open("cpmpy/timing_results/all_interval_z3.txt", "w") as f:
                ...
                tablesp_ortools_CSE.add_row([lngth, average_model_creation_time_2, average_transform_time_2, average_solve_time_2, average_execution_time_2, average_mem_usage_2])
                with open("cpmpy/timing_results/all_interval_z3_CSE.txt", "w") as f:
                ...
                tablesp_ortools_factor.add_row([lngth, factor_model_creation_time, factor_tranform_time, factor_solve_time, factor_execution_time, factor_mem_usage])
                with open("cpmpy/CSE_results/all_interval_z3.txt", "w") as f:
