...
if __name__ == "__main__":
    ...
    tablesp_ortools = PrettyTable(['Length', 'Model Creation Time', 'Solver Creation + Transform Time', 'Solve Time', 'Overall Execution Time', 'Overall Memory Usage (Bytes)'])
    tablesp_ortools.title = 'Results of the Auto Correlation problem without CSE'
    tablesp_ortools_CSE = PrettyTable(['Length', 'Model Creation Time', 'Solver Creation + Transform Time', 'Solve Time', 'Overall Execution Time', 'Overall Memory Usage (Bytes)'])
    ...
    for length in range(10, 20):
        ...
        for slvr in ['z3', 'z3_2']:
            ...
            if slvr == 'z3':
                ...
                tablesp_ortools.add_row([length, average_model_creation_time, average_transform_time, average_solve_time, average_execution_time, average_mem_usage])
                with open("cpmpy/timing_results/auto_correlation_z3.txt", "w") as f:
                ...
                tablesp_ortools_CSE.add_row([length, average_model_creation_time_2, average_transform_time_2, average_solve_time_2, average_execution_time_2, average_mem_usage_2])
                with open("cpmpy/timing_results/auto_correlation_z3_CSE.txt", "w") as f:
                ...
                tablesp_ortools_factor.add_row([length, factor_model_creation_time, factor_tranform_time, factor_solve_time, factor_execution_time, factor_mem_usage])
                with open("cpmpy/CSE_results/auto_correlation_z3.txt", "w") as f:
