    ...
    for sz in range(8, 12):
        ...
        for slvr in ['z3', 'z3_2']:
            ...
            if slvr == 'z3':
                ...
                tablesp_ortools.add_row([size, average_model_creation_time, average_transform_time, average_solve_time, average_execution_time, average_mem_usage])
                with open("cpmpy/timing_results/golomb_z3.txt", "w") as f:
                ...
                tablesp_ortools_CSE.add_row([size, average_model_creation_time_2, average_transform_time_2, average_solve_time_2, average_execution_time_2, average_mem_usage_2])
                with open("cpmpy/timing_results/golomb_z3_CSE.txt", "w") as f:
                ...
                tablesp_ortools_factor.add_row([size, factor_model_creation_time, factor_tranform_time, factor_solve_time, factor_execution_time, factor_mem_usage])
                with open("cpmpy/CSE_results/golomb_z3.txt", "w") as f:
