    ...
    for sz in range(5, 15):
        ...
        for slvr in ["ortools", "ortools_CSE"]:
            ...
            if slvr == 'ortools':
                ...
                tablesp_ortools.add_row([args.size, average_model_creation_time, average_transform_time, average_solve_time, average_execution_time, average_num_branches, average_mem_usage])
            ...
            if slvr == 'ortools_CSE':
                ...
                tablesp_ortools_CSE.add_row([args.size, average_model_creation_time_2, average_transform_time_2, average_solve_time_2, average_execution_time_2, average_num_branches_2, average_mem_usage_2])
                ...
                tablesp_ortools_factor.add_row([args.size, factor_model_creation_time, factor_tranform_time, factor_solve_time, factor_execution_time, factor_num_branches, factor_mem_usage])
