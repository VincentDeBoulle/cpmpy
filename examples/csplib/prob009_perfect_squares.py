...
if __name__ == "__main__":
    ...
    tablesp_ortools.title = 'Results of the Perfect Squares problem with CSE (average of 10 iterations)'
    ...
    tablesp_ortools_noCSE.title = 'Results of the Perfect Squares problem without CSE (average of 10 iterations)'    
