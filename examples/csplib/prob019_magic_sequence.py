    ...
    for n in range(100, 155, 5):
        ...
        for slvr in ["ortools", "ortools_CSE"]:
            ...
            if slvr == 'ortools':
                ...
                tablesp_ortools_CSE.add_row([args.length, average_model_creation_time_2, average_transform_time_2, average_solve_time_2, average_execution_time_2, average_num_branches_2])
                with open("cpmpy/timing_results/magic_sequence.txt", "w") as f:
                ...
                tablesp_ortools_factor.add_row([args.length, factor_model_creation_time, factor_tranform_time, factor_solve_time, factor_execution_time, factor_num_branches])
