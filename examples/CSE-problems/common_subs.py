...
if __name__ == "__main__":
    ...
    for slvr in ["ortools", "ortools_2"]:
        ...
        if slvr == 'ortools':
            ...
            with open("cpmpy/timing_results/common_subs.txt", "w") as f:
            ...
            with open("cpmpy/timing_results/common_subs_CSE.txt", "w") as f:
            ...
            with open("cpmpy/CSE_results/common_subs.txt", "w") as f:
