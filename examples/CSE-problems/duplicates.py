...
if __name__ == "__main__":
    ...
    tablesp_ortools =  PrettyTable(['Numbers of repetitions', 'Model Creation Time', 'Solver Creation + Transform Time', 'Solve Time', 'Overall Execution Time'])
    tablesp_ortools.title = 'Results of the Duplicates problem without CSE'
    tablesp_ortools_CSE =  PrettyTable(['Numbers of repetitions', 'Model Creation Time', 'Solver Creation + Transform Time', 'Solve Time', 'Overall Execution Time'])
    tablesp_ortools_CSE.title = 'Results of the Duplicates problem with CSE'    
    tablesp_ortools_factor =  PrettyTable(['Numbers of repetitions', 'Model Creation Time', 'Solver Creation + Transform Time', 'Solve Time', 'Overall Execution Time'])
    ...
    for n in range(1000, 10001, 500):
        ...
        for slvr in ["z3", "z3_2"]:
            ...
            if slvr == 'z3':
                ...
                with open("cpmpy/timing_results/duplicates_z3.txt", "w") as f:
                ...
                with open("cpmpy/timing_results/duplicates_z3_CSE.txt", "w") as f:
                ...
                with open("cpmpy/CSE_results/duplicates_z3.txt", "w") as f:
