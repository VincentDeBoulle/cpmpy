...
if __name__ == "__main__":
    ...
    tablesp_ortools =  PrettyTable(['Amount of repetitions', 'Model Creation Time', 'Solver Creation + Transform Time', 'Solve Time', 'Overall Execution Time'])
    tablesp_ortools.title = 'Results of the Permutations problem without CSE'
    tablesp_ortools_CSE =  PrettyTable(['Amount of repetitions', 'Model Creation Time', 'Solver Creation + Transform Time', 'Solve Time', 'Overall Execution Time'])
    tablesp_ortools_CSE.title = 'Results of the Permutations problem with CSE'    
    tablesp_ortools_factor =  PrettyTable(['Number of repetitions', 'Model Creation Time', 'Solver Creation + Transform Time', 'Solve Time', 'Overall Execution Time'])
    ...
    for n in range(10, 201, 10):
        ...
        for slvr in ["z3", "z3_2"]:
            ...
            if slvr == 'z3':
                ...
                with open("cpmpy/timing_results/permutations_z3.txt", "w") as f:
                ...
                with open("cpmpy/timing_results/permutations_z3_CSE.txt", "w") as f:
                ...
                with open("cpmpy/CSE_results/permutations_z3.txt", "w") as f:
